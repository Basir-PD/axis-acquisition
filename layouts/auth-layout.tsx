...
import { HorizontalGradient } from '@/components/contact/horizontal-gradient'
      ...
      <div className="w-full min-h-screen grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="relative w-full z-20 hidden md:flex border-l border-neutral-100 dark:border-neutral-800 overflow-hidden bg-gray-50 dark:bg-neutral-900 items-center justify-center">
          <div className="max-w-sm mx-auto">
            ...
            >
              Axis Acquisition is used by thousands of users
            </p>
            <p
              className={cn(
            ...
            >
              With lots of AI applications around, Axis Acquisition stands out with
