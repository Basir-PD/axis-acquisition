...
export default function MultiStepForm({
    ...
    async (data: any) => {
      ...
      try {
        ...
        const submissionData = {
          ...data,
          // Map budget_range to budget for database compatibility
          budget: data.budget_range || data.budget || '',
          // Map services based on primary_goal and automation_interest
          services: [
            data.primary_goal,
        ...
        delete submissionData.budget_range
        delete submissionData.company_name
        delete submissionData.primary_goal
        delete submissionData.automation_interest
        delete submissionData.current_challenges
  ...
  const handleFormKeyDown = async (
    ...
    if (event.key === 'Enter') {
      ...
      if (currentStep === -1) {
        // On welcome screen, move to first question
        setCurrentStep(0)
                        ...
                        {currentStep < questions.length ? (
                          ...
                          >
                            ...
                            <div className="space-y-4 md:space-y-6 flex-shrink-0">
                              ...
                              {/* Question Text */}
                              <h1
                                className={`text-2xl md:text-3xl lg:text-4xl font-bold leading-tight max-w-4xl ${
                                  questions[currentStep].highlight
                          ...
                          >
                            ...
                            <div className="space-y-4">
                              <h1 className="text-4xl md:text-5xl font-bold text-black">
                                <FormattedMessage
                                  id="typeform.success.submissionTitle"
                                  defaultMessage="🎉 Thank you for your submission!"
                                />
                              </h1>
                              <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
                                <FormattedMessage
                                  id="typeform.success.submissionMessage"
                                  defaultMessage="We've received your information and our team will reach out to you soon to discuss your project requirements and how we can help bring your vision to life."
                                />
                              </p>
                              <p className="text-lg text-gray-500">
                                <FormattedMessage
                                  id="typeform.success.checkEmail"
                                  defaultMessage="Check your email for next steps!"
                                />
                              </p>
                            </div>
      ...
      <div className="space-y-2">
        {question.options?.map((option, index) => (
          ...
          >
            ...
            <Label
              ...
              className={`flex items-center w-full p-3 cursor-pointer transition-all duration-200 group-hover:bg-gray-50 ${
                value === option
                  ? 'bg-gray-50'
                  : 'bg-transparent hover:bg-gray-50'
              }`}
        ...
        {question.hasOther && (
          ...
          >
            ...
            <Label
              htmlFor={`${question.id}-other`}
              className={`flex items-start w-full p-3 cursor-pointer transition-all duration-200 group-hover:bg-gray-50 ${
                value === 'other'
                  ? 'bg-gray-50'
                  : 'bg-transparent hover:bg-gray-50'
              }`}
