import aiQuestions from '@/data/ai-automation-questions.json'
...
// Use AI automation questions from JSON file
export const questions: Question[] = aiQuestions.questions as Question[]
