  ...
  return (
    ...
    >
      ...
      <div className="h-[22rem] w-[32rem] bg-[#272729] rounded-2xl overflow-hidden relative -z-10">
        ...
        {/* {showGradient && (
          <div className="h-40 w-full absolute bottom-0 inset-x-0 bg-gradient-to-t from-charcoal  via-charcoal to-transparent z-10"></div>
        )} */}
...
export const Lid = ({ src }: { src?: string }) => {
  return (
    <motion.div className="relative [perspective:800px] z-10">
      <motion.div
        style={{
          perspective: '1000px',
          rotateX: -65,
