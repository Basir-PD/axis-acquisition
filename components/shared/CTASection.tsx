      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          {(variant === 'getStarted' || variant === 'both') && (
            <Link href="/contact">
              <Button className="px-8 md:px-12 py-4 md:py-5 text-lg md:text-xl font-semibold !bg-primary !hover:bg-primary-dark !text-white !opacity-100 shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-200 rounded-lg">
                <FormattedMessage
                  id="cta.getStarted"
