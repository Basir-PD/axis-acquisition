  ...
  return (
    <div className="pt-10 pb-20  flex flex-col items-center justify-center  relative mb-20 w-full">
      ...
      <div className="relative flex flex-col items-center">
        ...
        <blockquote className="max-w-4xl mx-auto text-sm md:text-2xl text-center !leading-9 text-slate-700 dark:text-slate-300 mb-8">
          {testimonial.content}
        </blockquote>
        <h4 className="max-w-4xl mx-auto text-xs md:text-lg text-center !leading-9 text-black dark:text-white font-medium">
          {testimonial.name}
        </h4>
        <span className="max-w-4xl mx-auto text-xs md:text-base text-center !leading-9 text-slate-500 dark:text-slate-400">
