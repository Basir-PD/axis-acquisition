  ...
  return (
    <div className="py-6 lg:py-10 flex flex-col lg:flex-row  my-20">
      <div className="pr-4">
        ...
        <div className="text-sm text-slate-600 dark:text-slate-200 max-w-xs mt-4 leading-6">
          {product.description}
        </div>
        ...
        <div className="mt-6">
          <a
            href={product.link}
            target="__blank"
            className="inline-flex justify-center rounded-lg text-sm font-semibold py-3 px-4 bg-slate-900 text-white hover:bg-slate-700 dark:hover:bg-slate-800"
          >
            Live Preview
          </a>
        </div>
