...
function IconContainer({
  ...
  // Reduce the scale range
  const widthTransform = useTransform(distance, [-150, 0, 150], [45, 60, 45])
  const heightTransform = useTransform(distance, [-150, 0, 150], [45, 60, 45])
    ...
    <Link href={href}>
      ...
      >
        <AnimatePresence>
          {hovered && (
            <motion.div
              initial={{ opacity: 0, y: 10, x: '-50%' }} // Reduce y from 10 to 5
